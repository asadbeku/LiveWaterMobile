package uz.prestige.livewater.users
...
import uz.prestige.livewater.users.view_model.AddUserViewModel
...
class AddUserActivity : AppCompatActivity() {
    ...
    private var userInfo: UserType? = null
    ...
    private fun getFromBundle() {
        ...
        userInfo?.let { user ->
            binding.name.setText(user.firstName)
            binding.surname.setText(user.lastName)
            binding.username.setText(user.username)
            binding.region.editText?.setText(viewModel.getRegionName("", regionsList))
            binding.phoneNumber.setText(user.phoneNumber.removeFirstThreeDigits())
            binding.roleEditText.editText?.setText(user.role)
